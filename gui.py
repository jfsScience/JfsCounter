...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.webEngineView = QtWebEngineWidgets.QWebEngineView(parent=self.tab_2)
        ...
        self.back_button = QtWidgets.QPushButton("Back", self.tab_2)
        self.verticalLayout.insertWidget(0, self.back_button)  # Fügt Button über dem WebView ein
        self.back_button.clicked.connect(self.webEngineView.back)
